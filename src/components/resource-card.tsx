...
export function ResourceCard({ resource, index }: ResourceCardProps) {
  ...
  return (
    <a
      ...
      className="touch-press group flex flex-col overflow-hidden rounded-2xl border border-[#eee] bg-white transition-all duration-200 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:rounded-[20px]"
    >
      {/* Thumbnail */}
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-3.5 sm:gap-2 sm:p-5">
        ...
        {/* Title */}
        <h3 className="line-clamp-2 text-[14px] font-bold leading-[1.45] text-[#1a1a1a] sm:text-[16px]">
        ...
        {/* Arrow */}
        <div className="mt-auto flex items-center gap-1 pt-1.5 text-[12px] font-semibold text-primary sm:pt-2 sm:text-[13px] sm:opacity-0 sm:transition-opacity sm:duration-200 sm:group-hover:opacity-100">
          자료 열기
